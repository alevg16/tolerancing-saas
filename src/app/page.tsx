  ...
  return (
    <div style={{ background: C.paper, color: C.ink, fontFamily: SANS }}>
      ...
      >
        ...
        <Link
          href="/login"
          style={{ fontSize: 13, color: C.sub, textDecoration: "none", padding: "8px 10px" }}
        >
          Sign in
        </Link>
        <Link
      ...
      {/* hero */}
      <section style={{ maxWidth: 720, margin: "0 auto", padding: "44px 22px 30px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 16, color: C.sub, lineHeight: 1.55, margin: "0 auto 22px", maxWidth: 560 }}>
          ISO-grounded fit, stack-up, thread and bolt calculators for mechanical
          teams — with saved projects, a shared company standards library and
          branded reports.
        </p>
        <div style={{ display: "flex", gap: 18, justifyContent: "center", flexWrap: "wrap" }}>
          {MODULES.map((m) => (
            <span key={m.slug} className="mono" style={{ fontSize: 11.5, color: C.faint }}>
              {m.label} · {m.standard}
            </span>
          ))}
        </div>
      ...
      {/* free tool hook */}
      <section style={{ maxWidth: 920, margin: "0 auto", padding: "0 14px 60px" }}>
        <div
          style={{
            display: "flex",
            alignItems: "center",
        ...
        >
          ...
          <span style={{ fontSize: 13, color: C.sub, fontFamily: MONO }}>
            Try the ISO 286 hole / shaft fit calculator
          </span>
        </div>
        <div
          style={{
